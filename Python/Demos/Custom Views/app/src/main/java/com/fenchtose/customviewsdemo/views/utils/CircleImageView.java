package com.fenchtose.customviewsdemo.views.utils;
...
/**
 * ImageView whose shape will be a circle instead of a square by default.
 */
public class CircleImageView extends ImageView {
    ...
    public CircleImageView(Context context, AttributeSet attrs, int defStyle) {
        ...
        mBorderWidth = a.getDimensionPixelSize(R.styleable.CircleImageView_borderThickness,
