...
```
      ...
      --cache-dir string                     Directory rclone will use for caching. (default "C:\\Users\\natew\\AppData\\Local\\rclone")
...
```
      ...
      --cache-chunk-path string                                  Directory to cache chunk files. (default "C:\\Users\\natew\\AppData\\Local\\rclone\\cache-backend")
      ...
      --cache-db-path string                                     Directory to store file structure metadata DB. (default "C:\\Users\\natew\\AppData\\Local\\rclone\\cache-backend")
  ...
  -L, --copy-links                                               Follow symlinks and copy the pointed to item.
      ...
      --ftp-user string                                          FTP username, leave blank for current username, DESKTOP\natew
  ...
  -l, --links                                                    Translate symlinks to/from regular files with a '.rclonelink' extension
      ...
      --local-encoding MultiEncoder                              This sets the encoding for the backend. (default Slash,LtGt,DoubleQuote,Colon,Question,Asterisk,Pipe,BackSlash,Ctl,RightSpace,RightPeriod,InvalidUtf8,Dot)
  ...
  -x, --one-file-system                                          Don't cross filesystem boundaries (unix/macOS only).
      ...
      --sftp-user string                                         SSH username, leave blank for current username, DESKTOP\natew
