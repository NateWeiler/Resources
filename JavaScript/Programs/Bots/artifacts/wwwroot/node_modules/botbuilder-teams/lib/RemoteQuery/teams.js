...
Teams.prototype.fetchMemberListWithPaging = function (conversationId, options, callback) {
    ...
    var pageSize = (options && options.pageSize !== undefined) ? options.pageSize : undefined;
    ...
    var baseUrl = this.client.baseUri;
    var requestUrl = baseUrl + (baseUrl.endsWith('/') ? '' : '/') + 'v3/conversations/{conversationId}/pagedMembers';
    requestUrl = requestUrl.replace('{conversationId}', encodeURIComponent(conversationId));
    var queryParameters = [];
