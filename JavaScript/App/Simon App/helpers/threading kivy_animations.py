''' Helper snippet for animations.
Taken from: https://github.com/kivy/kivy/wiki/Working-with-Python-threads-inside-a-Kivy-application
Summary

author: dessant
kivy: >= 1.8.0
OpenGL related operations (widget, canvas, property manipulation etc.) should be done only in the main thread. This example shows us how to use Clock or the mainthread decorator to perform these actions, and how to use threading events to stop hanging threads when the app is about to close.
'''
